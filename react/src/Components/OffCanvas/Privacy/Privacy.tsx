const Privacy = () => {
    return (
        <div id="privacy" className="offcanvas offcanvas-bottom" aria-labelledby="privacy">
            <div className="offcanvas-body small overflow-auto">
                ...
                <br />
                <p>Do you like <s>Baileys</s> <a rel="noreferrer" href="https://23mjo-tyaaa-aaaad-qdt5a-cai.ic.fleek.co/"
                    target="_blank">ICP</a>?</p>
            </div>
        </div>
    )
}
