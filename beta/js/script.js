...
var button = document.getElementById("pay1");
...
var button = document.getElementById("sellwar");
button.addEventListener("click", function (e) {
    DePayWidgets.Sale({
        sell: {
            'polygon': '0xe87c2deb370231729e7248386a65420f9282d2bb'
        }
    });
});
